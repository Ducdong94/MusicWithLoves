...
public class Song {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "sourceSong", cascade = {CascadeType.PERSIST, CascadeType.MERGE})
    private List<Source> source;
    @ManyToMany(fetch = FetchType.LAZY, cascade = {CascadeType.PERSIST, CascadeType.MERGE})
    @JoinTable(name = "song_cate", joinColumns = {@JoinColumn(name = "song_id")}, inverseJoinColumns = {
            @JoinColumn(name = "category_id")})
    private List<Category> songCategories = new ArrayList<>();
    @NotNull
    private long time;
    @ManyToMany(fetch = FetchType.LAZY, cascade = {CascadeType.PERSIST, CascadeType.MERGE})
    ...
    public List<Category> getSongCategories() {
        return songCategories;
    }

    public void setSongCategories(List<Category> songCategories) {
